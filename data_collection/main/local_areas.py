...
from main.util.paths import CLEAN_PATH, RAW_LOCAL_AREA, RAW_PROVINCES

# ==========================================================================
# PARAMETERS
# ==========================================================================
df_la = pd.read_excel(RAW_LOCAL_AREA)
...
# ==========================================================================
def main():
    map_id(df_p, "id", "ID", df_la, "province_id")
    export_path = os.path.join(CLEAN_PATH, "local_area.xlsx")
    export_xlsx(df_la, export_path)
